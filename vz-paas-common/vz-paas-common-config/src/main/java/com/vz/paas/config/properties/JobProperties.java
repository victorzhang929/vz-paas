...
public class JobProperties {
    ...
    private class JobTask {
        ...
        @Data
        private class JobCoreProperties {
            /**
             * 作业名称
             */
            ...
            /**
             * 分片序列号和参数等号分隔，多个键值对用逗号分隔，分片序列号从0开始，不可大于或等于作业分片总数
             */
            ...
            /**
             * 是否开启任务执行失败转移，开启表示如果作业在一次任务执行中途宕机，允许将该次未完成的任务在另一作业节点上补偿执行
             */
            ...
            /**
             * 配置jobProperties定义的美剧控制Elastic-Job的实现细节JOB_EXCEPTION_HANDLER用于扩展异常类EXECUTOR_SERVICE_HANDLER用于扩展作业处理线程池类
             */
