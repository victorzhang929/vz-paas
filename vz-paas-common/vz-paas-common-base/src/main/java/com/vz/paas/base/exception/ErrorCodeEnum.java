...
public enum ErrorCodeEnum {
    ...
    GL99990404(99990403, "找不到资源"),
    GL99990001(99990001, "注解使用错误"),
    GL99990002(99990002, "微服务不在线，或者网络超时"),
    UAC10010001(10010001, "会话超时，请刷新页面"),
    UAC10010002(10010002, "TOKEN解析失败"),
    UAC10010003(10010003, "操作过快，您的账号已被冻结"),
    ...
    UAC10011016(10011016, "用户名或者密码错误"),
    ...
    UAC10015004(10015004, "找不到组织信息，groupId=%ss"),
    ...
    MDC10021005(10021005, "商品不是在线售卖状态, productId=%s"),
    MDC10021006(10021006, "商品库存不足, productId=%s"),
    MDC10021007(10021007, "产品已下架或者删除, productId=%s"),
    MDC10021008(10021008, "找不到数据字典信息, dictId=%s"),
    MDC10021009(10021009, "更新字典状态失败, dictId=%s"),
    MDC10021010(10021010, "上级数据字典不存在, dictId=%s"),
    MDC10021011(10021011, "商品ID不能为空"),
    MDC10021012(10021012, "商品编码不能为空"),
    MDC10021013(10021013, "更新商品信息失败, productId=%s"),
    MDC10021014(10021014, "删除商品信息失败, productId=%s"),
    MDC10022001(10022001, "找不到商品分类信息, categoryId=%s"),
    MDC10022002(10022002, "上级商品分类不存在, categoryId=%s"),
    ...
    OMC10031015(10031015, "更新购物车数据失败, cartId=%s"),
    ...
    TPC10050010(10050010, "Topic=%s, 无消费者订阅"),
    TPC10050011(10050011, "Mq编码转换异常, MessageKey=%s"),
    TPC10050012(10050012, "发送MQ失败, MessageKey=%s"),
    TPC10050013(10050013, "延迟级别错误, Topic=%s, MessageKey=%s"),
    TPC10050014(10050014, "MQ重试三次,仍然发送失败, Topic=%s, MessageKey=%s"),
    TPC10050015(10050015, "消息PID不能为空, messageKey=%s");
